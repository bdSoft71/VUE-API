                    ...
                    <form @submit.prevent=" editMode ? product_update() : product_add()">
                        ...
                        <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name" class="form-control" id="product_name" v-model="form.product_name"   placeholder="Enter Product name">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="product_long_description" id="product_long_description" v-model="form.product_long_description"  cols="30" rows="4" class="form-control" placeholder="Product long description"></textarea>
                                    <div v-if="form.errors.has('product_long_description')" v-html="form.errors.get('product_long_description')" />
                                </div>
                                <div class="form-group">
                                    <label for="product_price">Product Price</label>
                                    <input type="number" name="product_price" id="product_price" v-model="form.product_price"  placeholder="Product Price" class="form-control">
