				...
				<div v-for="(product,index) in products.data" :key="index" class="col-md-3">
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <router-link :to="{ name: 'product_details', params:{product_id: product.id}}"> <img :src="'http://localhost/enjoyShop/public/uploads/product_images/'+product.product_image" alt=""></router-link>
